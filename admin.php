...
<head>
    ...
    <title>MTS Manba'ul Ulum - Admin Panel</title>
...
<body>
    ...
    <!-- Navbar (sama seperti index.php, tapi tambah logout) -->
    ...
    <!-- Home Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Profil Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Sejarah Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Visi Misi Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Hubungi Kami Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Berita Section (dengan tombol edit dan data dinamis) -->
    <section id="berita" class="section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Berita Terbaru</h2>
                <p class="section-subtitle">Informasi Terkini dari MTS Manba'ul Ulum</p>
                <button class="btn btn-outline" onclick="openEditModal('berita')">Edit Berita</button>
            </div>
<!-- Di bagian Berita Section -->
            <div class="news-grid">
                <?php foreach ($berita as $index => $item): ?>
                    <article class="news-card">
                        ...
                        <div class="news-actions">
                            <a href="edit_berita.php?index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
                            <a href="delete_berita.php?index=<?php echo $index; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus berita ini?');">Delete</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
            <div class="text-center">
                <a href="admin.php#berita" class="btn btn-outline">Lihat Semua Berita</a>
            </div>
        </div>
    </section>

    <!-- Agenda Section (dengan tombol edit dan data dinamis) -->
    <section id="agenda" class="section bg-light">
        <div class="container">
            <div class="section-header">
                ...
                <button class="btn btn-outline" onclick="openEditModal('agenda')">Edit Agenda</button>
            </div>
                    ...
                    <div class="agenda-item">
                        ...
                        <div class="agenda-content">
                            ...
                            <div class="agenda-actions">
                                <a href="edit_agenda.php?index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
                                <a href="delete_agenda.php?index=<?php echo $index; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus agenda ini?');">Delete</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <!-- FAQ Section (sama seperti index.php, tanpa edit) -->
    ...
    <!-- Prestasi Section (dengan tombol edit dan data dinamis) -->
    <section id="prestasi" class="section bg-light">
        <div class="container">
            <div class="section-header">
                ...
                <button class="btn btn-outline" onclick="openEditModal('prestasi')">Edit Prestasi</button>
            </div>
                    ...
                    <?php foreach (($prestasi['akademik'] ?? []) as $index => $item): ?>
                        <div class="achievement-card">
                            ...
                            <div class="achievement-actions">
                                <a href="edit_prestasi.php?type=akademik&index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
                                <a href="delete_prestasi.php?type=akademik&index=<?php echo $index; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus prestasi ini?');">Delete</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="achievement-grid" id="non-akademik">
                    <?php foreach (($prestasi['non-akademik'] ?? []) as $index => $item): ?>
                        <div class="achievement-card">
                            ...
                            <div class="achievement-actions">
                                <a href="edit_prestasi.php?type=non-akademik&index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
                                <a href="delete_prestasi.php?type=non-akademik&index=<?php echo $index; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus prestasi ini?');">Delete</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
    ...
    <!-- Gallery Section (dengan tombol edit dan data dinamis) -->
    <section id="gallery" class="section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Gallery</h2>
                <p class="section-subtitle">Dokumentasi Kegiatan Sekolah</p>
                <button class="btn btn-outline" onclick="openEditModal('gallery')">Edit Gallery</button>
            </div>
                    ...
                    <div class="gallery-item" data-category="<?php echo htmlspecialchars($item['category']); ?>">
                        ...
                        <div class="gallery-overlay">
                            ...
                            <div class="gallery-actions">
                                <a href="edit_gallery.php?index=<?php echo $index; ?>" class="btn btn-edit">Edit</a>
                                <a href="delete_gallery.php?index=<?php echo $index; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus gallery ini?');">Delete</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <!-- PPDB Section (sama seperti index.php, tanpa edit) -->
    ...
    <div class="floating-upload" id="floatingUpload">
        <button class="upload-btn" onclick="toggleDropup()">
            <i class="fas fa-plus"></i>
        </button>
        <div class="dropup-menu" id="dropupMenu">
            <a href="upload.php?type=berita"><i class="fas fa-newspaper"></i> Berita</a>
            <a href="upload.php?type=agenda"><i class="fas fa-calendar"></i> Agenda</a>
            <a href="upload.php?type=gallery"><i class="fas fa-images"></i> Gallery</a>
            <a href="upload.php?type=prestasi"><i class="fas fa-trophy"></i> Prestasi</a>
        </div>
    </div>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="edit.php">
                <!-- Form dinamis berdasarkan section -->
                <input type="hidden" name="section" id="editSection">
                <div id="editFields">
                    <!-- Fields akan diisi oleh JS -->
                </div>
